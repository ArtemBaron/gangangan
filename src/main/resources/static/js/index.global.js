    ...
    function t(t, a) {
        ...
        for (let a = 0; a < t.length; a++) {
            ...
            a += 1;
                ...
                if ((32 === g || g === e || 9 === g) && (l = t.charCodeAt(a + 1)) && (32 === l || l === e || 9 === l || 13 === l && (l = t.charCodeAt(a + 2)) && l == e))
                continue;
                if (g === e) {
                    if (0 === p.length)
                    continue;
...
return S(e.slice(0, t).trim(), e.slice(t + 1, -1 === r ? e.length : r).trim(), -1 !== r)
}
function o(t, r, n) {
let o;
...
if (o === n)
return a;
if (59 === o && (t.charCodeAt(a + 1) === e || 13 === t.charCodeAt(a + 1) && t.charCodeAt(a + 2) === e))
throw new Error(`Unterminated string: ${t.slice(r, a + 1) + String.fromCharCode(n)}`);
if (o === e || 13 === o && t.charCodeAt(a + 1) === e)
throw new Error(`Unterminated string: ${t.slice(r, a) + String.fromCharCode(n)}`)
}
return r
}
function a(e) {
...
let t, r = String(e), n = r.length, o = -1, a = "", i = r.charCodeAt(0);
if (1 === n && 45 === i)
return "\\" + r;
for (; ++o < n; )
t = r.charCodeAt(o),
a += 0 !== t ? t >= 1 && t <= 31 || 127 === t || 0 === o && t >= 48 && t <= 57 || 1 === o && t >= 48 && t <= 57 && 45 === i ? "\\" + t.toString(16) + " " : t >= 128 || 45 === t || 95 === t || t >= 48 && t <= 57 || t >= 65 && t <= 90 || t >= 97 && t <= 122 ? r.charAt(o) : "\\" + r.charAt(o) : "�";
return a
}
function i(e) {
return e.replace(/\\([\dA-Fa-f]{1,6}[\t\n\f\r ]?|[\S\s])/g, (e => e.length > 2 ? String.fromCodePoint(Number.parseInt(e.slice(1).trim(), 16)) : e[1]))
}
var l = new Map([["--font", ["--font-weight", "--font-size"]], ["--inset", ["--inset-shadow", "--inset-ring"]], ["--text", ["--text-color", "--text-decoration-color", "--text-decoration-thickness", "--text-indent", "--text-shadow", "--text-underline-offset"]], ["--grid-column", ["--grid-column-start", "--grid-column-end"]], ["--grid-row", ["--grid-row-start", "--grid-row-end"]]]);
function s(e, t) {
...
58 === t || 44 === t || 61 === t || 62 === t || 60 === t || 10 === t || 32 === t || 9 === t); l++)
;
i = l - 1;
let s = p(e.slice(n, l));
...
return a.length > 0 && r.push(d(a)),
r
}
var g, v = ((g = v || {})[g.Continue = 0] = "Continue",
g[g.Skip = 1] = "Skip",
g[g.Stop = 2] = "Stop",
...
continue;
default:
throw new Error(`Invalid \`WalkAction.${v[r.kind] ?? `Unknown(${r.kind})`}\` in enter.`)
}
}
let c = ~l
...
case 3:
case 4:
i.splice(c, 1, ...u.nodes),
a[1] = c + u.nodes.length;
continue;
case 5:
return void i.splice(c, 1, ...u.nodes);
default:
throw new Error(`Invalid \`WalkAction.${v[u.kind] ?? `Unknown(${u.kind})`}\` in exit.`)
}
}
}
function y(e) {
...
if (h.theme && "-" === e.property[0] && "-" === e.property[1])
for (let t of y(e.value))
f.get(t).add(e.property);
else
t.trackUsedVariables(e.value);
if ("animation" === e.property)
for (let t of U(e.value))
s.add(t);
2 & r && e.value.includes("color-mix(") && i.get(u).add(e),
u.push(e)
} else if ("rule" === e.kind) {
let t = [];
...
, l = new Set;
do {
if ("function" !== o.kind || "var" !== o.value)
return;
let e = o.nodes[0];
if (!e || "word" !== e.kind)
return;
...
if (e.length > 0) {
let t = g.findIndex((e => !("comment" === e.kind || "at-rule" === e.kind && ("@charset" === e.name || "@import" === e.name))))
, r = A("@layer", "properties", []);
r.src = e[0].src,
g.splice(t < 0 ? g.length : t, 0, r);
let n = z("@layer properties", [A("@supports", "((-webkit-hyphens: none) and (not (margin-trim: inline))) or ((-moz-orient: inline) and (not (color:rgb(from red r g b))))", e)]);
n.src = e[0].src,
...
var W = ["calc", "min", "max", "clamp", "mod", "rem", "sin", "cos", "tan", "asin", "acos", "atan", "atan2", "pow", "sqrt", "hypot", "log", "exp", "round"];
function R(e) {
...
if (i >= 48 && i <= 57 || null !== n && (37 === i || i >= 97 && i <= 122 || i >= 65 && i <= 90) ? n = a : (o = n,
n = null),
40 !== i)
if (41 === i)
t += e[a],
...
32 === e.charCodeAt(a - 1) ? t += `${e[a]} ` : t += n >= 48 && n <= 57 || l >= 48 && l <= 57 || 41 === n || 40 === l || 43 === l || 42 === l || 47 === l || 45 === l || null !== o && o === a - 1 ? ` ${e[a]} ` : e[a]
}
}
else {
t += e[a];
...
0 != e || "word" !== t.nodes[e].kind ? L([t.nodes[e]]) : t.nodes[e].value = _(t.nodes[e].value, !0);
break
}
t.value = _(t.value),
L(t.nodes);
...
return "(" === e[0] && ")" === e[e.length - 1] ? "-" === (e = e.slice(1, -1))[0] && "-" === e[1] && I(e) ? {
kind: "arbitrary",
value: D(e = `var(${e})`)
} : null : {
kind: "named",
...
, [n,o] = t ? ["(", ")"] : ["[", "]"];
return "arbitrary" === e.kind ? `/${n}${X(r)}${o}` : "named" === e.kind ? `/${e.value}` : ""
}
function G(e) {
if ("static" === e.kind)
return e.root;
...
t += "-",
t += G(e.variant)),
("functional" === e.kind || "compound" === e.kind) && (t += Y(e.modifier)),
t
}
var J = new u((e => {
let t = m(e)
...
"separator" === e.kind && e.value.length > 0 && "" === e.value.trim() ? (o[0] === e || o[o.length - 1] === e) && r.add(e) : "separator" === e.kind && "," === e.value.trim() && (e.value = ",");
else {
let t = o.indexOf(e) ?? -1;
if (-1 === t)
return;
...
var Q = new u((e => {
let t = m(e);
return 3 === t.length && "word" === t[0].kind && "&" === t[0].value && "separator" === t[1].kind && ":" === t[1].value && "function" === t[2].kind && "is" === t[2].value ? h(t[2].nodes) : e
}
));
function ee(e) {
for (let t of e)
...
return q(e, " ").every((e => ye(e) || ge(e) || "thin" === e || "medium" === e || "thick" === e))
},
image: function(e) {
let t = 0;
for (let r of q(e, ","))
...
, a = null;
for (let e of r)
Te.has(e) || (Ve.test(e) ? (null === o ? o = e : null === a && (a = e),
Ve.lastIndex = 0) : null === n && (n = e));
if (null === o || null === a)
return e;
...
, Ne = /^-?[a-z][a-zA-Z0-9/%._-]*-\*$/
, Oe = ["0", "0.5", "1", "1.5", "2", "2.5", "3", "3.5", "4", "5", "6", "7", "8", "9", "10", "11", "12", "14", "16", "20", "24", "28", "32", "36", "40", "44", "48", "52", "56", "60", "64", "72", "80", "96"]
, Fe = class {
utilities = new u(( () => []));
completions = new Map;
static(e, t) {
...
getCompletions(e) {
return this.has(e, "static") ? this.completions.get(e)?.() ?? [{
supportsNegative: !1,
values: [],
modifiers: []
...
;
function Ue(e, t, r) {
return A("@property", e, [S("syntax", r ? `"${r}"` : '"*"'), S("inherits", "false"), ...t ? [S("initial-value", t)] : []])
}
function We(e, t) {
if (null === t)
return e;
...
if ("number" === r && !Se(t))
continue;
if ("percentage" === r && !Ae(t.slice(0, -1)))
continue
}
return {
nodes: m(t),
...
let a = !1
, i = Ke(t, (e => null == r ? n(e) : e.startsWith("current") ? n(We(e, r)) : ((e.startsWith("var(") || r.startsWith("var(")) && (a = !0),
n(Re(e, r)))));
function l(e) {
return o ? q(e, ",").map((e => o + e)).join(",") : e
}
return a ? [S(e, l(Ke(t, n))), z("@supports (color: lab(from red l a b))", [S(e, l(i))])] : [S(e, l(i))]
}
function Pe(e, t, r, n, o="") {
let a = !1
, i = q(t, ",").map((e => Ke(e, (e => null == r ? n(e) : e.startsWith("current") ? n(We(e, r)) : ((e.startsWith("var(") || r.startsWith("var(")) && (a = !0),
n(Re(e, r))))))).map((e => `drop-shadow(${e})`)).join(" ");
return a ? [S(e, o + q(t, ",").map((e => `drop-shadow(${Ke(e, n)})`)).join(" ")), z("@supports (color: lab(from red l a b))", [S(e, o + i)])] : [S(e, o + i)]
}
var qe = {
"--alpha": function(e, t, r, ...n) {
let[o,a] = q(r, "/").map((e => e.trim()));
if (!o || !a)
throw new Error(`The --alpha(…) function requires a color and an alpha value, e.g.: \`--alpha(${o || "var(--my-color)"} / ${a || "50%"})\``);
if (n.length > 0)
throw new Error(`The --alpha(…) function only accepts one argument, e.g.: \`--alpha(${o || "var(--my-color)"} / ${a || "50%"})\``);
return We(o, a)
},
...
var He = new RegExp(Object.keys(qe).map((e => `${e}\\(`)).join("|"));
function Ze(e, t) {
let r = 0;
return k(e, (e => {
if ("declaration" === e.kind && e.value && He.test(e.value))
return r |= 8,
void (e.value = Ye(e.value, e, t));
"at-rule" === e.kind && ("@media" === e.name || "@custom-media" === e.name || "@container" === e.name || "@supports" === e.name) && He.test(e.params) && (r |= 8,
e.params = Ye(e.params, e, t))
}
)),
r
}
...
, o = !1;
k(t, (e => {
"rule" === e.kind ? n.push(e.selector) : "at-rule" === e.kind && "@variant" === e.name ? o = !0 : "at-rule" === e.kind && "@slot" !== e.name && n.push(`${e.name} ${e.params}`)
}
)),
this.static(e, (e => {
let n = t.map(V);
...
applyFn: r,
compounds: n
}) : (void 0 === a && (this.lastOrder = this.nextOrder(),
a = this.lastOrder),
this.variants.set(e, {
kind: t,
applyFn: r,
...
function et(e, t) {
k(e, (e => "at-rule" === e.kind && "@slot" === e.name ? w.Replace(t) : "at-rule" !== e.kind || "@keyframes" !== e.name && "@property" !== e.name ? void 0 : (Object.assign(e, T([A(e.name, e.params, e.nodes)])),
w.Skip)))
}
function tt(e, t) {
let r = 0;
return k(e, (e => {
if ("at-rule" !== e.kind || "@variant" !== e.name)
return;
let n = $("&", e.nodes)
, o = e.params
, a = t.parseVariant(o);
...
function n(e, r) {
t.static(e, ( () => r.map((e => "function" == typeof e ? e() : S(e[0], e[1])))))
}
function o(n, o) {
...
if (null !== n)
return o.handle(t ? `calc(${n} * -1)` : n, a)
}
}
if (o.supportsNegative && t.functional(`-${n}`, a({
negative: !0
})),
t.functional(n, a({
negative: !1
...
r = De(r, t.modifier, e)) : r = _e(t, e, o.themeKeys),
...
handleBareValue: ({value: e}) => Ae(e) ? e : null,
handle: e => [S("overflow", "hidden"), S("display", "-webkit-box"), S("-webkit-box-orient", "vertical"), S("-webkit-line-clamp", e)],
staticValues: {
none: [S("overflow", "visible"), S("display", "block"), S("-webkit-box-orient", "horizontal"), S("-webkit-line-clamp", "unset")]
}
}),
r("line-clamp", ( () => [{
values: ["1", "2", "3", "4", "5", "6"],
...
i("size", ["--size", "--spacing"], (e => [S("--tw-sort", "size"), S("width", e), S("height", e)]), {
supportsFractions: !0
});
...
let r = [S("--tw-sort", "--tw-container-component"), S("width", "100%")];
for (let e of t)
...
return Ae(t) && Ae(r) ? [S("flex", `calc(${e.value.fraction} * 100%)`)] : void 0
}
if (Ae(e.value.value))
return e.modifier ? void 0 : [S("flex", e.value.value)]
}
...
i("basis", ["--flex-basis", "--spacing", "--container"], (e => [S("flex-basis", e)]), {
supportsFractions: !0
}),
...
let l = () => T([Ue("--tw-border-spacing-x", "0", "<length>"), Ue("--tw-border-spacing-y", "0", "<length>")]);
i("border-spacing", ["--border-spacing", "--spacing"], (e => [l(), S("--tw-border-spacing-x", e), S("--tw-border-spacing-y", e), S("border-spacing", "var(--tw-border-spacing-x) var(--tw-border-spacing-y)")])),
i("border-spacing-x", ["--border-spacing", "--spacing"], (e => [l(), S("--tw-border-spacing-x", e), S("border-spacing", "var(--tw-border-spacing-x) var(--tw-border-spacing-y)")])),
i("border-spacing-y", ["--border-spacing", "--spacing"], (e => [l(), S("--tw-border-spacing-y", e), S("border-spacing", "var(--tw-border-spacing-x) var(--tw-border-spacing-y)")])),
o("origin", {
...
staticValues: {
none: [S("perspective", "none")]
}
});
let s = () => T([Ue("--tw-translate-x", "0"), Ue("--tw-translate-y", "0"), Ue("--tw-translate-z", "0")]);
...
n("translate-full", [s, ["--tw-translate-x", "100%"], ["--tw-translate-y", "100%"], ["translate", "var(--tw-translate-x) var(--tw-translate-y)"]]),
i("translate", ["--translate", "--spacing"], (e => [s(), S("--tw-translate-x", e), S("--tw-translate-y", e), S("translate", "var(--tw-translate-x) var(--tw-translate-y)")]), {
supportsNegative: !0,
supportsFractions: !0
});
for (let e of ["x", "y"])
...
n(`translate-${e}-full`, [s, [`--tw-translate-${e}`, "100%"], ["translate", "var(--tw-translate-x) var(--tw-translate-y)"]]),
i(`translate-${e}`, ["--translate", "--spacing"], (t => [s(), S(`--tw-translate-${e}`, t), S("translate", "var(--tw-translate-x) var(--tw-translate-y)")]), {
supportsNegative: !0,
supportsFractions: !0
});
i("translate-z", ["--translate", "--spacing"], (e => [s(), S("--tw-translate-z", e), S("translate", "var(--tw-translate-x) var(--tw-translate-y) var(--tw-translate-z)")]), {
supportsNegative: !0
}),
n("translate-3d", [s, ["translate", "var(--tw-translate-x) var(--tw-translate-y) var(--tw-translate-z)"]]);
let c = () => T([Ue("--tw-scale-x", "1"), Ue("--tw-scale-y", "1"), Ue("--tw-scale-z", "1")]);
...
n = t ? `calc(${n} * -1)` : n,
[S("scale", n)]) : (n = e.resolve(r.value.value, ["--scale"]),
!n && Ae(r.value.value) && (n = `${r.value.value}%`),
n ? (n = t ? `calc(${n} * -1)` : n,
[c(), S("--tw-scale-x", n), S("--tw-scale-y", n), S("--tw-scale-z", n), S("scale", "var(--tw-scale-x) var(--tw-scale-y)")]) : void 0)
}
}
...
themeKeys: ["--scale"],
handleBareValue: ({value: e}) => Ae(e) ? `${e}%` : null,
handle: t => [c(), S(`--tw-scale-${e}`, t), S("scale", "var(--tw-scale-x) var(--tw-scale-y)" + ("z" === e ? " var(--tw-scale-z)" : ""))]
}),
r(`scale-${e}`, ( () => [{
supportsNegative: !0,
values: ["0", "50", "75", "90", "95", "100", "105", "110", "125", "150", "200"],
...
if ("vector" === e)
return [S("rotate", `${n} var(--tw-rotate)`)];
if ("angle" !== e)
...
, a = () => T([Ue("--tw-rotate-x"), Ue("--tw-rotate-y"), Ue("--tw-rotate-z"), Ue("--tw-skew-x"), Ue("--tw-skew-y")]);
for (let t of ["x", "y", "z"])
o(`rotate-${t}`, {
supportsNegative: !0,
themeKeys: ["--rotate"],
handleBareValue: ({value: e}) => Ae(e) ? `${e}deg` : null,
handle: r => [a(), S(`--tw-rotate-${t}`, `rotate${t.toUpperCase()}(${r})`), S("transform", e)]
}),
r(`rotate-${t}`, ( () => [{
supportsNegative: !0,
values: ["0", "1", "2", "3", "6", "12", "45", "90", "180"],
...
themeKeys: ["--skew"],
handleBareValue: ({value: e}) => Ae(e) ? `${e}deg` : null,
handle: t => [a(), S("--tw-skew-x", `skewX(${t})`), S("--tw-skew-y", `skewY(${t})`), S("transform", e)]
}),
o("skew-x", {
supportsNegative: !0,
themeKeys: ["--skew"],
handleBareValue: ({value: e}) => Ae(e) ? `${e}deg` : null,
handle: t => [a(), S("--tw-skew-x", `skewX(${t})`), S("transform", e)]
}),
o("skew-y", {
supportsNegative: !0,
themeKeys: ["--skew"],
handleBareValue: ({value: e}) => Ae(e) ? `${e}deg` : null,
handle: t => [a(), S("--tw-skew-y", `skewY(${t})`), S("transform", e)]
}),
r("skew", ( () => [{
supportsNegative: !0,
values: ["0", "1", "2", "3", "6", "12"],
...
let f = () => T([Ue("--tw-pan-x"), Ue("--tw-pan-y"), Ue("--tw-pinch-zoom")]);
...
handleBareValue: ({value: e}) => ze(e) ? `repeat(${e}, minmax(0, 1fr))` : null,
...
i("space-x", ["--space", "--spacing"], (e => [T([Ue("--tw-space-x-reverse", "0")]), $(":where(& > :not(:last-child))", [S("--tw-sort", "row-gap"), S("--tw-space-x-reverse", "0"), S("margin-inline-start", `calc(${e} * var(--tw-space-x-reverse))`), S("margin-inline-end", `calc(${e} * calc(1 - var(--tw-space-x-reverse)))`)])]), {
supportsNegative: !0
}),
i("space-y", ["--space", "--spacing"], (e => [T([Ue("--tw-space-y-reverse", "0")]), $(":where(& > :not(:last-child))", [S("--tw-sort", "column-gap"), S("--tw-space-y-reverse", "0"), S("margin-block-start", `calc(${e} * var(--tw-space-y-reverse))`), S("margin-block-end", `calc(${e} * calc(1 - var(--tw-space-y-reverse)))`)])]), {
supportsNegative: !0
}),
n("space-x-reverse", [ () => T([Ue("--tw-space-x-reverse", "0")]), () => $(":where(& > :not(:last-child))", [S("--tw-sort", "row-gap"), S("--tw-space-x-reverse", "1")])]),
n("space-y-reverse", [ () => T([Ue("--tw-space-y-reverse", "0")]), () => $(":where(& > :not(:last-child))", [S("--tw-sort", "column-gap"), S("--tw-space-y-reverse", "1")])]),
...
handle: e => [$(":where(& > :not(:last-child))", [S("--tw-sort", "divide-color"), S("border-color", e)])]
}),
...
let r = t.value.value;
switch (t.value.dataType ?? ce(r, ["color", "line-width", "length"])) {
case "line-width":
case "length":
{
if (t.modifier)
...
a("border", {
width: e => [S("border-style", "var(--tw-border-style)"), S("border-width", e)],
color: e => [S("border-color", e)]
}),
a("border-x", {
width: e => [S("border-inline-style", "var(--tw-border-style)"), S("border-inline-width", e)],
color: e => [S("border-inline-color", e)]
}),
a("border-y", {
width: e => [S("border-block-style", "var(--tw-border-style)"), S("border-block-width", e)],
color: e => [S("border-block-color", e)]
}),
a("border-s", {
width: e => [S("border-inline-start-style", "var(--tw-border-style)"), S("border-inline-start-width", e)],
color: e => [S("border-inline-start-color", e)]
}),
a("border-e", {
width: e => [S("border-inline-end-style", "var(--tw-border-style)"), S("border-inline-end-width", e)],
color: e => [S("border-inline-end-color", e)]
}),
a("border-t", {
width: e => [S("border-top-style", "var(--tw-border-style)"), S("border-top-width", e)],
color: e => [S("border-top-color", e)]
}),
a("border-r", {
width: e => [S("border-right-style", "var(--tw-border-style)"), S("border-right-width", e)],
color: e => [S("border-right-color", e)]
}),
a("border-b", {
width: e => [S("border-bottom-style", "var(--tw-border-style)"), S("border-bottom-width", e)],
color: e => [S("border-bottom-color", e)]
}),
a("border-l", {
width: e => [S("border-left-style", "var(--tw-border-style)"), S("border-left-width", e)],
...
handle: e => [T([Ue("--tw-divide-x-reverse", "0")]), $(":where(& > :not(:last-child))", [S("--tw-sort", "divide-x-width"), i(), S("--tw-divide-x-reverse", "0"), S("border-inline-style", "var(--tw-border-style)"), S("border-inline-start-width", `calc(${e} * var(--tw-divide-x-reverse))`), S("border-inline-end-width", `calc(${e} * calc(1 - var(--tw-divide-x-reverse)))`)])]
}),
o("divide-y", {
defaultValue: e.get(["--default-border-width"]) ?? "1px",
themeKeys: ["--divide-width", "--border-width"],
handleBareValue: ({value: e}) => Ae(e) ? `${e}px` : null,
handle: e => [T([Ue("--tw-divide-y-reverse", "0")]), $(":where(& > :not(:last-child))", [S("--tw-sort", "divide-y-width"), i(), S("--tw-divide-y-reverse", "0"), S("border-bottom-style", "var(--tw-border-style)"), S("border-top-style", "var(--tw-border-style)"), S("border-top-width", `calc(${e} * var(--tw-divide-y-reverse))`), S("border-bottom-width", `calc(${e} * calc(1 - var(--tw-divide-y-reverse)))`)])]
}),
r("divide-x", ( () => [{
values: ["0", "2", "4", "8"],
...
n("divide-x-reverse", [ () => T([Ue("--tw-divide-x-reverse", "0")]), () => $(":where(& > :not(:last-child))", [S("--tw-divide-x-reverse", "1")])]),
n("divide-y-reverse", [ () => T([Ue("--tw-divide-y-reverse", "0")]), () => $(":where(& > :not(:last-child))", [S("--tw-divide-y-reverse", "1")])]);
for (let e of ["solid", "dashed", "dotted", "double", "none"])
n(`divide-${e}`, [ () => $(":where(& > :not(:last-child))", [S("--tw-sort", "divide-style"), S("--tw-border-style", e), S("border-style", e)])])
}
...
handle(e) {
if (e)
return [S("background-position", e)]
}
}),
...
return;
let e = r.value.value;
return "angle" === (r.value.dataType ?? ce(e, ["angle"])) ? (e = t ? `calc(${e} * -1)` : `${e}`,
[S("--tw-gradient-position", e), S("background-image", `linear-gradient(var(--tw-gradient-stops,${e}))`)]) : t ? void 0 : [S("--tw-gradient-position", e), S("background-image", `linear-gradient(var(--tw-gradient-stops,${e}))`)]
}
let n = r.value.value;
if (!t && i.has(n))
n = i.get(n);
...
let o = e(r.modifier);
return [S("--tw-gradient-position", `${n}`), z("@supports (background-image: linear-gradient(in lab, red, red))", [S("--tw-gradient-position", `${n} ${o}`)]), S("background-image", "linear-gradient(var(--tw-gradient-stops))")]
}
}
...
return;
let e = r.value.value;
return [S("--tw-gradient-position", e), S("background-image", `conic-gradient(var(--tw-gradient-stops,${e}))`)]
}
let n = e(r.modifier);
if (!r.value)
return [S("--tw-gradient-position", n), S("background-image", "conic-gradient(var(--tw-gradient-stops))")];
let o = r.value.value;
return Ae(o) ? (o = t ? `calc(${o}deg * -1)` : `${o}deg`,
[S("--tw-gradient-position", `from ${o} ${n}`), S("background-image", "conic-gradient(var(--tw-gradient-stops))")]) : void 0
}
}
, a = ["oklab", "oklch", "srgb", "hsl", "longer", "shorter", "increasing", "decreasing"]
, i = new Map([["to-t", "to top"], ["to-tr", "to top right"], ["to-r", "to right"], ["to-br", "to bottom right"], ["to-b", "to bottom"], ["to-bl", "to bottom left"], ["to-l", "to left"], ["to-tl", "to top left"]]);
...
if (!t.value)
return [S("--tw-gradient-position", e(t.modifier)), S("background-image", "radial-gradient(var(--tw-gradient-stops))")];
if ("arbitrary" === t.value.kind) {
if (t.modifier)
return;
let e = t.value.value;
return [S("--tw-gradient-position", e), S("background-image", `radial-gradient(var(--tw-gradient-stops,${e}))`)]
}
}
)),
r("bg-radial", ( () => [{
...
if ("arbitrary" === t.value.kind) {
let r = t.value.value;
switch (t.value.dataType ?? ce(r, ["image", "color", "percentage", "position", "bg-size", "length", "url"])) {
case "percentage":
case "position":
...
let h = () => T([Ue("--tw-gradient-position"), Ue("--tw-gradient-from", "#0000", "<color>"), Ue("--tw-gradient-via", "#0000", "<color>"), Ue("--tw-gradient-to", "#0000", "<color>"), Ue("--tw-gradient-stops"), Ue("--tw-gradient-via-stops"), Ue("--tw-gradient-from-position", "0%", "<length-percentage>"), Ue("--tw-gradient-via-position", "50%", "<length-percentage>"), Ue("--tw-gradient-to-position", "100%", "<length-percentage>")]);
function m(n, o) {
t.functional(n, (t => {
if (t.value) {
if ("arbitrary" === t.value.kind) {
let r = t.value.value;
switch (t.value.dataType ?? ce(r, ["color", "length", "percentage"])) {
case "length":
case "percentage":
...
if (r)
return o.position(r);
if ("%" === t.value.value[t.value.value.length - 1] && Ae(t.value.value.slice(0, -1)))
...
m("from", {
color: e => [h(), S("--tw-sort", "--tw-gradient-from"), S("--tw-gradient-from", e), S("--tw-gradient-stops", "var(--tw-gradient-via-stops, var(--tw-gradient-position), var(--tw-gradient-from) var(--tw-gradient-from-position), var(--tw-gradient-to) var(--tw-gradient-to-position))")],
position: e => [h(), S("--tw-gradient-from-position", e)]
}),
n("via-none", [["--tw-gradient-via-stops", "initial"]]),
m("via", {
color: e => [h(), S("--tw-sort", "--tw-gradient-via"), S("--tw-gradient-via", e), S("--tw-gradient-via-stops", "var(--tw-gradient-position), var(--tw-gradient-from) var(--tw-gradient-from-position), var(--tw-gradient-via) var(--tw-gradient-via-position), var(--tw-gradient-to) var(--tw-gradient-to-position)"), S("--tw-gradient-stops", "var(--tw-gradient-via-stops)")],
position: e => [h(), S("--tw-gradient-via-position", e)]
}),
m("to", {
color: e => [h(), S("--tw-sort", "--tw-gradient-to"), S("--tw-gradient-to", e), S("--tw-gradient-stops", "var(--tw-gradient-via-stops, var(--tw-gradient-position), var(--tw-gradient-from) var(--tw-gradient-from-position), var(--tw-gradient-to) var(--tw-gradient-to-position))")],
...
return;
let t = e.value.value;
switch (e.value.dataType ?? ce(t, ["image", "percentage", "position", "bg-size", "length", "url"])) {
case "percentage":
case "position":
...
let g = () => T([Ue("--tw-mask-linear", "linear-gradient(#fff, #fff)"), Ue("--tw-mask-radial", "linear-gradient(#fff, #fff)"), Ue("--tw-mask-conic", "linear-gradient(#fff, #fff)")]);
function v(n, o) {
t.functional(n, (t => {
if (t.value) {
if ("arbitrary" === t.value.kind) {
let r = t.value.value;
switch (t.value.dataType ?? ce(r, ["length", "percentage", "color"])) {
case "color":
return r = De(r, t.modifier, e),
null === r ? void 0 : o.color(r);
case "percentage":
return t.modifier || !Ae(r.slice(0, -1)) ? void 0 : o.position(r);
default:
return t.modifier ? void 0 : o.position(r)
}
}
...
{
let r = e.resolve(null, ["--spacing"]);
return r && Se(t.value.value) ? o.position(`calc(${r} * ${t.value.value})`) : void 0
}
case "percentage":
return Ae(t.value.value.slice(0, -1)) ? o.position(t.value.value) : void 0;
default:
return
}
}
...
let w = () => T([Ue("--tw-mask-left", "linear-gradient(#fff, #fff)"), Ue("--tw-mask-right", "linear-gradient(#fff, #fff)"), Ue("--tw-mask-bottom", "linear-gradient(#fff, #fff)"), Ue("--tw-mask-top", "linear-gradient(#fff, #fff)")]);
function k(e, t, r) {
v(e, {
color(e) {
let n = [g(), w(), S("mask-image", "var(--tw-mask-linear), var(--tw-mask-radial), var(--tw-mask-conic)"), S("mask-composite", "intersect"), S("--tw-mask-linear", "var(--tw-mask-left), var(--tw-mask-right), var(--tw-mask-bottom), var(--tw-mask-top)")];
for (let o of ["top", "right", "bottom", "left"])
r[o] && (n.push(S(`--tw-mask-${o}`, `linear-gradient(to ${o}, var(--tw-mask-${o}-from-color) var(--tw-mask-${o}-from-position), var(--tw-mask-${o}-to-color) var(--tw-mask-${o}-to-position))`)),
n.push(T([Ue(`--tw-mask-${o}-from-position`, "0%"), Ue(`--tw-mask-${o}-to-position`, "100%"), Ue(`--tw-mask-${o}-from-color`, "black"), Ue(`--tw-mask-${o}-to-color`, "transparent")])),
...
let b = () => T([Ue("--tw-mask-linear-position", "0deg"), Ue("--tw-mask-linear-from-position", "0%"), Ue("--tw-mask-linear-to-position", "100%"), Ue("--tw-mask-linear-from-color", "black"), Ue("--tw-mask-linear-to-color", "transparent")]);
o("mask-linear", {
defaultValue: null,
supportsNegative: !0,
supportsFractions: !1,
handleBareValue: e => Ae(e.value) ? `calc(1deg * ${e.value})` : null,
handleNegativeBareValue: e => Ae(e.value) ? `calc(1deg * -${e.value})` : null,
handle: e => [g(), b(), S("mask-image", "var(--tw-mask-linear), var(--tw-mask-radial), var(--tw-mask-conic)"), S("mask-composite", "intersect"), S("--tw-mask-linear", "linear-gradient(var(--tw-mask-linear-stops, var(--tw-mask-linear-position)))"), S("--tw-mask-linear-position", e)]
}),
r("mask-linear", ( () => [{
supportsNegative: !0,
values: ["0", "1", "2", "3", "6", "12", "45", "90", "180"]
...
v("mask-linear-from", {
color: e => [g(), b(), S("mask-image", "var(--tw-mask-linear), var(--tw-mask-radial), var(--tw-mask-conic)"), S("mask-composite", "intersect"), S("--tw-mask-linear-stops", "var(--tw-mask-linear-position), var(--tw-mask-linear-from-color) var(--tw-mask-linear-from-position), var(--tw-mask-linear-to-color) var(--tw-mask-linear-to-position)"), S("--tw-mask-linear", "linear-gradient(var(--tw-mask-linear-stops))"), S("--tw-mask-linear-from-color", e)],
position: e => [g(), b(), S("mask-image", "var(--tw-mask-linear), var(--tw-mask-radial), var(--tw-mask-conic)"), S("mask-composite", "intersect"), S("--tw-mask-linear-stops", "var(--tw-mask-linear-position), var(--tw-mask-linear-from-color) var(--tw-mask-linear-from-position), var(--tw-mask-linear-to-color) var(--tw-mask-linear-to-position)"), S("--tw-mask-linear", "linear-gradient(var(--tw-mask-linear-stops))"), S("--tw-mask-linear-from-position", e)]
}),
v("mask-linear-to", {
color: e => [g(), b(), S("mask-image", "var(--tw-mask-linear), var(--tw-mask-radial), var(--tw-mask-conic)"), S("mask-composite", "intersect"), S("--tw-mask-linear-stops", "var(--tw-mask-linear-position), var(--tw-mask-linear-from-color) var(--tw-mask-linear-from-position), var(--tw-mask-linear-to-color) var(--tw-mask-linear-to-position)"), S("--tw-mask-linear", "linear-gradient(var(--tw-mask-linear-stops))"), S("--tw-mask-linear-to-color", e)],
position: e => [g(), b(), S("mask-image", "var(--tw-mask-linear), var(--tw-mask-radial), var(--tw-mask-conic)"), S("mask-composite", "intersect"), S("--tw-mask-linear-stops", "var(--tw-mask-linear-position), var(--tw-mask-linear-from-color) var(--tw-mask-linear-from-position), var(--tw-mask-linear-to-color) var(--tw-mask-linear-to-position)"), S("--tw-mask-linear", "linear-gradient(var(--tw-mask-linear-stops))"), S("--tw-mask-linear-to-position", e)]
});
let y = () => T([Ue("--tw-mask-radial-from-position", "0%"), Ue("--tw-mask-radial-to-position", "100%"), Ue("--tw-mask-radial-from-color", "black"), Ue("--tw-mask-radial-to-color", "transparent"), Ue("--tw-mask-radial-shape", "ellipse"), Ue("--tw-mask-radial-size", "farthest-corner"), Ue("--tw-mask-radial-position", "center")]);
...
supportsNegative: !1,
supportsFractions: !1,
handle: e => [g(), y(), S("mask-image", "var(--tw-mask-linear), var(--tw-mask-radial), var(--tw-mask-conic)"), S("mask-composite", "intersect"), S("--tw-mask-radial", "radial-gradient(var(--tw-mask-radial-stops, var(--tw-mask-radial-size)))"), S("--tw-mask-radial-size", e)]
}),
v("mask-radial-from", {
color: e => [g(), y(), S("mask-image", "var(--tw-mask-linear), var(--tw-mask-radial), var(--tw-mask-conic)"), S("mask-composite", "intersect"), S("--tw-mask-radial-stops", "var(--tw-mask-radial-shape) var(--tw-mask-radial-size) at var(--tw-mask-radial-position), var(--tw-mask-radial-from-color) var(--tw-mask-radial-from-position), var(--tw-mask-radial-to-color) var(--tw-mask-radial-to-position)"), S("--tw-mask-radial", "radial-gradient(var(--tw-mask-radial-stops))"), S("--tw-mask-radial-from-color", e)],
position: e => [g(), y(), S("mask-image", "var(--tw-mask-linear), var(--tw-mask-radial), var(--tw-mask-conic)"), S("mask-composite", "intersect"), S("--tw-mask-radial-stops", "var(--tw-mask-radial-shape) var(--tw-mask-radial-size) at var(--tw-mask-radial-position), var(--tw-mask-radial-from-color) var(--tw-mask-radial-from-position), var(--tw-mask-radial-to-color) var(--tw-mask-radial-to-position)"), S("--tw-mask-radial", "radial-gradient(var(--tw-mask-radial-stops))"), S("--tw-mask-radial-from-position", e)]
}),
v("mask-radial-to", {
color: e => [g(), y(), S("mask-image", "var(--tw-mask-linear), var(--tw-mask-radial), var(--tw-mask-conic)"), S("mask-composite", "intersect"), S("--tw-mask-radial-stops", "var(--tw-mask-radial-shape) var(--tw-mask-radial-size) at var(--tw-mask-radial-position), var(--tw-mask-radial-from-color) var(--tw-mask-radial-from-position), var(--tw-mask-radial-to-color) var(--tw-mask-radial-to-position)"), S("--tw-mask-radial", "radial-gradient(var(--tw-mask-radial-stops))"), S("--tw-mask-radial-to-color", e)],
position: e => [g(), y(), S("mask-image", "var(--tw-mask-linear), var(--tw-mask-radial), var(--tw-mask-conic)"), S("mask-composite", "intersect"), S("--tw-mask-radial-stops", "var(--tw-mask-radial-shape) var(--tw-mask-radial-size) at var(--tw-mask-radial-position), var(--tw-mask-radial-from-color) var(--tw-mask-radial-from-position), var(--tw-mask-radial-to-color) var(--tw-mask-radial-to-position)"), S("--tw-mask-radial", "radial-gradient(var(--tw-mask-radial-stops))"), S("--tw-mask-radial-to-position", e)]
});
let x = () => T([Ue("--tw-mask-conic-position", "0deg"), Ue("--tw-mask-conic-from-position", "0%"), Ue("--tw-mask-conic-to-position", "100%"), Ue("--tw-mask-conic-from-color", "black"), Ue("--tw-mask-conic-to-color", "transparent")]);
o("mask-conic", {
defaultValue: null,
supportsNegative: !0,
supportsFractions: !1,
handleBareValue: e => Ae(e.value) ? `calc(1deg * ${e.value})` : null,
handleNegativeBareValue: e => Ae(e.value) ? `calc(1deg * -${e.value})` : null,
handle: e => [g(), x(), S("mask-image", "var(--tw-mask-linear), var(--tw-mask-radial), var(--tw-mask-conic)"), S("mask-composite", "intersect"), S("--tw-mask-conic", "conic-gradient(var(--tw-mask-conic-stops, var(--tw-mask-conic-position)))"), S("--tw-mask-conic-position", e)]
}),
r("mask-conic", ( () => [{
supportsNegative: !0,
values: ["0", "1", "2", "3", "6", "12", "45", "90", "180"]
...
if ("arbitrary" === t.value.kind) {
let r = t.value.value;
switch (t.value.dataType ?? ce(r, ["color", "number", "length", "percentage"])) {
case "number":
case "length":
case "percentage":
return t.modifier ? void 0 : [S("stroke-width", r)];
default:
return r = De(t.value.value, t.modifier, e),
...
i("indent", ["--text-indent", "--spacing"], (e => [S("text-indent", e)]), {
supportsNegative: !0
}),
...
if ("arbitrary" === t.value.kind) {
let e = t.value.value;
switch (t.value.dataType ?? ce(e, ["number", "generic-name", "family-name"])) {
case "generic-name":
case "family-name":
return [S("font-family", e)];
default:
return [T([Ue("--tw-font-weight")]), S("--tw-font-weight", e), S("font-weight", e)]
}
}
{
...
if (r) {
let[e,t={}] = r;
return [S("font-family", e), S("font-feature-settings", t["--font-feature-settings"]), S("font-variation-settings", t["--font-variation-settings"])]
}
}
{
let r = e.resolve(t.value.value, ["--font-weight"]);
if (r)
return [T([Ue("--tw-font-weight")]), S("--tw-font-weight", r), S("font-weight", r)]
}
}
}
)),
...
handle: e => [$("&::placeholder", [S("--tw-sort", "placeholder-color"), S("color", e)])]
}),
...
case "length":
case "percentage":
return t.modifier ? void 0 : [S("text-decoration-thickness", r)];
default:
return r = De(r, t.modifier, e),
...
return t.modifier ? void 0 : [S("text-decoration-thickness", r)];
if (Ae(t.value.value))
return t.modifier ? void 0 : [S("text-decoration-thickness", `${t.value.value}px`)]
}
{
let r = _e(t, e, ["--text-decoration-color", "--color"]);
if (r)
return [S("text-decoration-color", r)]
}
}
}
)),
...
, l = () => T([Ue("--tw-blur"), Ue("--tw-brightness"), Ue("--tw-contrast"), Ue("--tw-grayscale"), Ue("--tw-hue-rotate"), Ue("--tw-invert"), Ue("--tw-opacity"), Ue("--tw-saturate"), Ue("--tw-sepia"), Ue("--tw-drop-shadow"), Ue("--tw-drop-shadow-color"), Ue("--tw-drop-shadow-alpha", "100%", "<percentage>"), Ue("--tw-drop-shadow-size")])
, s = () => T([Ue("--tw-backdrop-blur"), Ue("--tw-backdrop-brightness"), Ue("--tw-backdrop-contrast"), Ue("--tw-backdrop-grayscale"), Ue("--tw-backdrop-hue-rotate"), Ue("--tw-backdrop-invert"), Ue("--tw-backdrop-opacity"), Ue("--tw-backdrop-saturate"), Ue("--tw-backdrop-sepia")]);
...
if (!e.modifier) {
if (null === e.value)
return [s(), S("-webkit-backdrop-filter", i), S("backdrop-filter", i)];
if ("arbitrary" === e.value.kind)
return [S("-webkit-backdrop-filter", e.value.value), S("backdrop-filter", e.value.value)];
if ("none" === e.value.value)
return [S("-webkit-backdrop-filter", "none"), S("backdrop-filter", "none")]
}
}
)),
o("blur", {
themeKeys: ["--blur"],
handle: e => [l(), S("--tw-blur", `blur(${e})`), S("filter", a)],
staticValues: {
...
handle: e => [s(), S("--tw-backdrop-blur", `blur(${e})`), S("-webkit-backdrop-filter", i), S("backdrop-filter", i)],
staticValues: {
none: [s(), S("--tw-backdrop-blur", " "), S("-webkit-backdrop-filter", i), S("backdrop-filter", i)]
}
}),
o("brightness", {
themeKeys: ["--brightness"],
handleBareValue: ({value: e}) => Ae(e) ? `${e}%` : null,
handle: e => [l(), S("--tw-brightness", `brightness(${e})`), S("filter", a)]
}),
o("backdrop-brightness", {
themeKeys: ["--backdrop-brightness", "--brightness"],
handleBareValue: ({value: e}) => Ae(e) ? `${e}%` : null,
handle: e => [s(), S("--tw-backdrop-brightness", `brightness(${e})`), S("-webkit-backdrop-filter", i), S("backdrop-filter", i)]
}),
r("brightness", ( () => [{
values: ["0", "50", "75", "90", "95", "100", "105", "110", "125", "150", "200"],
...
themeKeys: ["--contrast"],
handleBareValue: ({value: e}) => Ae(e) ? `${e}%` : null,
handle: e => [l(), S("--tw-contrast", `contrast(${e})`), S("filter", a)]
}),
o("backdrop-contrast", {
themeKeys: ["--backdrop-contrast", "--contrast"],
handleBareValue: ({value: e}) => Ae(e) ? `${e}%` : null,
handle: e => [s(), S("--tw-backdrop-contrast", `contrast(${e})`), S("-webkit-backdrop-filter", i), S("backdrop-filter", i)]
}),
r("contrast", ( () => [{
...
handleBareValue: ({value: e}) => Ae(e) ? `${e}%` : null,
defaultValue: "100%",
handle: e => [l(), S("--tw-grayscale", `grayscale(${e})`), S("filter", a)]
}),
o("backdrop-grayscale", {
themeKeys: ["--backdrop-grayscale", "--grayscale"],
handleBareValue: ({value: e}) => Ae(e) ? `${e}%` : null,
defaultValue: "100%",
handle: e => [s(), S("--tw-backdrop-grayscale", `grayscale(${e})`), S("-webkit-backdrop-filter", i), S("backdrop-filter", i)]
}),
r("grayscale", ( () => [{
...
handleBareValue: ({value: e}) => Ae(e) ? `${e}deg` : null,
handle: e => [l(), S("--tw-hue-rotate", `hue-rotate(${e})`), S("filter", a)]
}),
o("backdrop-hue-rotate", {
supportsNegative: !0,
themeKeys: ["--backdrop-hue-rotate", "--hue-rotate"],
handleBareValue: ({value: e}) => Ae(e) ? `${e}deg` : null,
handle: e => [s(), S("--tw-backdrop-hue-rotate", `hue-rotate(${e})`), S("-webkit-backdrop-filter", i), S("backdrop-filter", i)]
}),
r("hue-rotate", ( () => [{
...
handleBareValue: ({value: e}) => Ae(e) ? `${e}%` : null,
defaultValue: "100%",
handle: e => [l(), S("--tw-invert", `invert(${e})`), S("filter", a)]
}),
o("backdrop-invert", {
themeKeys: ["--backdrop-invert", "--invert"],
handleBareValue: ({value: e}) => Ae(e) ? `${e}%` : null,
defaultValue: "100%",
handle: e => [s(), S("--tw-backdrop-invert", `invert(${e})`), S("-webkit-backdrop-filter", i), S("backdrop-filter", i)]
}),
r("invert", ( () => [{
values: ["0", "25", "50", "75", "100"],
...
themeKeys: ["--saturate"],
handleBareValue: ({value: e}) => Ae(e) ? `${e}%` : null,
handle: e => [l(), S("--tw-saturate", `saturate(${e})`), S("filter", a)]
}),
o("backdrop-saturate", {
themeKeys: ["--backdrop-saturate", "--saturate"],
handleBareValue: ({value: e}) => Ae(e) ? `${e}%` : null,
handle: e => [s(), S("--tw-backdrop-saturate", `saturate(${e})`), S("-webkit-backdrop-filter", i), S("backdrop-filter", i)]
}),
r("saturate", ( () => [{
...
handleBareValue: ({value: e}) => Ae(e) ? `${e}%` : null,
defaultValue: "100%",
handle: e => [l(), S("--tw-sepia", `sepia(${e})`), S("filter", a)]
}),
o("backdrop-sepia", {
themeKeys: ["--backdrop-sepia", "--sepia"],
handleBareValue: ({value: e}) => Ae(e) ? `${e}%` : null,
defaultValue: "100%",
handle: e => [s(), S("--tw-backdrop-sepia", `sepia(${e})`), S("-webkit-backdrop-filter", i), S("backdrop-filter", i)]
}),
r("sepia", ( () => [{
values: ["0", "50", "100"],
...
let r;
if (t.modifier && ("arbitrary" === t.modifier.kind ? r = t.modifier.value : Ae(t.modifier.value) && (r = `${t.modifier.value}%`)),
!t.value) {
let t = e.get(["--drop-shadow"])
, n = e.resolve(null, ["--drop-shadow"]);
return null === t || null === n ? void 0 : [l(), S("--tw-drop-shadow-alpha", r), ...Pe("--tw-drop-shadow-size", t, r, (e => `var(--tw-drop-shadow-color, ${e})`)), S("--tw-drop-shadow", q(n, ",").map((e => `drop-shadow(${e})`)).join(" ")), S("filter", a)]
}
if ("arbitrary" === t.value.kind) {
let n = t.value.value;
return "color" === (t.value.dataType ?? ce(n, ["color"])) ? (n = De(n, t.modifier, e),
null === n ? void 0 : [l(), S("--tw-drop-shadow-color", We(n, "var(--tw-drop-shadow-alpha)")), S("--tw-drop-shadow", "var(--tw-drop-shadow-size)")]) : t.modifier && !r ? void 0 : [l(), S("--tw-drop-shadow-alpha", r), ...Pe("--tw-drop-shadow-size", n, r, (e => `var(--tw-drop-shadow-color, ${e})`)), S("--tw-drop-shadow", "var(--tw-drop-shadow-size)"), S("filter", a)]
}
{
let n = e.get([`--drop-shadow-${t.value.value}`])
, o = e.resolve(t.value.value, ["--drop-shadow"]);
if (n && o)
return t.modifier && !r ? void 0 : r ? [l(), S("--tw-drop-shadow-alpha", r), ...Pe("--tw-drop-shadow-size", n, r, (e => `var(--tw-drop-shadow-color, ${e})`)), S("--tw-drop-shadow", "var(--tw-drop-shadow-size)"), S("filter", a)] : [l(), S("--tw-drop-shadow-alpha", r), ...Pe("--tw-drop-shadow-size", n, r, (e => `var(--tw-drop-shadow-color, ${e})`)), S("--tw-drop-shadow", q(o, ",").map((e => `drop-shadow(${e})`)).join(" ")), S("filter", a)]
}
{
let r = _e(t, e, ["--drop-shadow-color", "--color"]);
if (r)
return "inherit" === r ? [l(), S("--tw-drop-shadow-color", "inherit"), S("--tw-drop-shadow", "var(--tw-drop-shadow-size)")] : [l(), S("--tw-drop-shadow-color", We(r, "var(--tw-drop-shadow-alpha)")), S("--tw-drop-shadow", "var(--tw-drop-shadow-size)")]
}
}
)),
r("drop-shadow", ( () => [{
...
handle: e => [s(), S("--tw-backdrop-opacity", `opacity(${e})`), S("-webkit-backdrop-filter", i), S("backdrop-filter", i)]
}),
r("backdrop-opacity", ( () => [{
values: Array.from({
length: 21
...
handle: e => [S("transition-property", e), S("transition-timing-function", a), S("transition-duration", i)],
staticValues: {
none: [S("transition-property", "none")],
all: [S("transition-property", "all"), S("transition-timing-function", a), S("transition-duration", i)],
colors: [S("transition-property", "color, background-color, border-color, outline-color, text-decoration-color, fill, stroke, --tw-gradient-from, --tw-gradient-via, --tw-gradient-to"), S("transition-timing-function", a), S("transition-duration", i)],
opacity: [S("transition-property", "opacity"), S("transition-timing-function", a), S("transition-duration", i)],
shadow: [S("transition-property", "box-shadow"), S("transition-timing-function", a), S("transition-duration", i)],
transform: [S("transition-property", "transform, translate, scale, rotate"), S("transition-timing-function", a), S("transition-duration", i)]
}
}),
...
null === n && Ae(t.value.value) && (n = `${t.value.value}ms`)),
null !== n ? [r(), S("--tw-duration", n), S("transition-duration", n)] : void 0
}
))
}
r("delay", ( () => [{
...
o("ease", {
themeKeys: ["--ease"],
handle: t => [e(), S("--tw-ease", t), S("transition-timing-function", t)],
staticValues: {
initial: [e(), S("--tw-ease", "initial")],
linear: [e(), S("--tw-ease", "linear"), S("transition-timing-function", "linear")]
}
})
}
...
o("content", {
themeKeys: [],
handle: e => [T([Ue("--tw-content", '""')]), S("--tw-content", e), S("content", "var(--tw-content)")]
});
{
let e = "var(--tw-contain-size,) var(--tw-contain-layout,) var(--tw-contain-paint,) var(--tw-contain-style,)"
, t = () => T([Ue("--tw-contain-size"), Ue("--tw-contain-layout"), Ue("--tw-contain-paint"), Ue("--tw-contain-style")]);
...
o("contain", {
themeKeys: [],
handle: e => [S("contain", e)]
})
}
n("forced-color-adjust-none", [["forced-color-adjust", "none"]]),
n("forced-color-adjust-auto", [["forced-color-adjust", "auto"]]),
i("leading", ["--leading", "--spacing"], (e => [T([Ue("--tw-leading")]), S("--tw-leading", e), S("line-height", e)]), {
staticValues: {
none: [T([Ue("--tw-leading")]), S("--tw-leading", "1"), S("line-height", "1")]
}
}),
o("tracking", {
supportsNegative: !0,
themeKeys: ["--tracking"],
handle: e => [T([Ue("--tw-tracking")]), S("--tw-tracking", e), S("letter-spacing", e)]
}),
...
, t = () => T([Ue("--tw-ordinal"), Ue("--tw-slashed-zero"), Ue("--tw-numeric-figure"), Ue("--tw-numeric-spacing"), Ue("--tw-numeric-fraction")]);
...
t.static("outline-hidden", ( () => [S("--tw-outline-style", "none"), S("outline-style", "none"), A("@media", "(forced-colors: active)", [S("outline", "2px solid transparent"), S("outline-offset", "2px")])])),
...
return [a(), S("outline-style", "var(--tw-outline-style)"), S("outline-width", r)]
}
if ("arbitrary" === t.value.kind) {
let r = t.value.value;
switch (t.value.dataType ?? ce(r, ["color", "length", "number", "percentage"])) {
case "length":
case "number":
case "percentage":
return t.modifier ? void 0 : [a(), S("outline-style", "var(--tw-outline-style)"), S("outline-width", r)];
default:
return r = De(r, t.modifier, e),
...
return [a(), S("outline-style", "var(--tw-outline-style)"), S("outline-width", r)];
if (Ae(t.value.value))
return [a(), S("outline-style", "var(--tw-outline-style)"), S("outline-width", `${t.value.value}px`)]
}
}
)),
r("outline", ( () => [{
...
staticValues: {
auto: [S("text-underline-offset", "auto")]
}
}),
r("underline-offset", ( () => [{
supportsNegative: !0,
...
if ("arbitrary" === t.value.kind) {
let r = t.value.value;
switch (t.value.dataType ?? ce(r, ["color", "length", "percentage", "absolute-size", "relative-size"])) {
case "size":
case "length":
case "percentage":
case "absolute-size":
...
return null;
let o = [S("font-size", n)];
return r && o.push(S("line-height", r)),
o
}
return "string" == typeof o ? [S("font-size", n), S("line-height", o)] : [S("font-size", n), S("line-height", o["--line-height"] ? `var(--tw-leading, ${o["--line-height"]})` : void 0), S("letter-spacing", o["--letter-spacing"] ? `var(--tw-tracking, ${o["--letter-spacing"]})` : void 0), S("font-weight", o["--font-weight"] ? `var(--tw-font-weight, ${o["--font-weight"]})` : void 0)]
}
}
}
}
...
let C = () => T([Ue("--tw-text-shadow-color"), Ue("--tw-text-shadow-alpha", "100%", "<percentage>")]);
...
return null === t ? void 0 : [C(), S("--tw-text-shadow-alpha", r), ...Ie("text-shadow", t, r, (e => `var(--tw-text-shadow-color, ${e})`))]
}
if ("arbitrary" === t.value.kind) {
let n = t.value.value;
return "color" === (t.value.dataType ?? ce(n, ["color"])) ? (n = De(n, t.modifier, e),
null === n ? void 0 : [C(), S("--tw-text-shadow-color", We(n, "var(--tw-text-shadow-alpha)"))]) : [C(), S("--tw-text-shadow-alpha", r), ...Ie("text-shadow", n, r, (e => `var(--tw-text-shadow-color, ${e})`))]
}
switch (t.value.value) {
case "none":
return t.modifier ? void 0 : [C(), S("text-shadow", "none")];
case "inherit":
return t.modifier ? void 0 : [C(), S("--tw-text-shadow-color", "inherit")]
}
{
let n = e.get([`--text-shadow-${t.value.value}`]);
if (n)
return [C(), S("--tw-text-shadow-alpha", r), ...Ie("text-shadow", n, r, (e => `var(--tw-text-shadow-color, ${e})`))]
}
{
let r = _e(t, e, ["--text-shadow-color", "--color"]);
if (r)
return [C(), S("--tw-text-shadow-color", We(r, "var(--tw-text-shadow-alpha)"))]
}
}
)),
r("text-shadow", ( () => [{
...
, l = "0 0 #0000"
, s = () => T([Ue("--tw-shadow", l), Ue("--tw-shadow-color"), Ue("--tw-shadow-alpha", "100%", "<percentage>"), Ue("--tw-inset-shadow", l), Ue("--tw-inset-shadow-color"), Ue("--tw-inset-shadow-alpha", "100%", "<percentage>"), Ue("--tw-ring-color"), Ue("--tw-ring-shadow", l), Ue("--tw-inset-ring-color"), Ue("--tw-inset-ring-shadow", l), Ue("--tw-ring-inset"), Ue("--tw-ring-offset-width", "0px", "<length>"), Ue("--tw-ring-offset-color", "#fff"), Ue("--tw-ring-offset-shadow", l)]);
...
!t.value) {
let t = e.get(["--shadow"]);
return null === t ? void 0 : [s(), S("--tw-shadow-alpha", r), ...Ie("--tw-shadow", t, r, (e => `var(--tw-shadow-color, ${e})`)), S("box-shadow", i)]
}
if ("arbitrary" === t.value.kind) {
let n = t.value.value;
return "color" === (t.value.dataType ?? ce(n, ["color"])) ? (n = De(n, t.modifier, e),
null === n ? void 0 : [s(), S("--tw-shadow-color", We(n, "var(--tw-shadow-alpha)"))]) : [s(), S("--tw-shadow-alpha", r), ...Ie("--tw-shadow", n, r, (e => `var(--tw-shadow-color, ${e})`)), S("box-shadow", i)]
}
switch (t.value.value) {
case "none":
return t.modifier ? void 0 : [s(), S("--tw-shadow", l), S("box-shadow", i)];
case "inherit":
return t.modifier ? void 0 : [s(), S("--tw-shadow-color", "inherit")]
}
{
let n = e.get([`--shadow-${t.value.value}`]);
if (n)
return [s(), S("--tw-shadow-alpha", r), ...Ie("--tw-shadow", n, r, (e => `var(--tw-shadow-color, ${e})`)), S("box-shadow", i)]
}
{
let r = _e(t, e, ["--box-shadow-color", "--color"]);
if (r)
return [s(), S("--tw-shadow-color", We(r, "var(--tw-shadow-alpha)"))]
}
}
)),
r("shadow", ( () => [{
...
return null === t ? void 0 : [s(), S("--tw-inset-shadow-alpha", r), ...Ie("--tw-inset-shadow", t, r, (e => `var(--tw-inset-shadow-color, ${e})`)), S("box-shadow", i)]
}
if ("arbitrary" === t.value.kind) {
let n = t.value.value;
return "color" === (t.value.dataType ?? ce(n, ["color"])) ? (n = De(n, t.modifier, e),
null === n ? void 0 : [s(), S("--tw-inset-shadow-color", We(n, "var(--tw-inset-shadow-alpha)"))]) : [s(), S("--tw-inset-shadow-alpha", r), ...Ie("--tw-inset-shadow", n, r, (e => `var(--tw-inset-shadow-color, ${e})`), "inset "), S("box-shadow", i)]
}
switch (t.value.value) {
case "none":
return t.modifier ? void 0 : [s(), S("--tw-inset-shadow", l), S("box-shadow", i)];
case "inherit":
return t.modifier ? void 0 : [s(), S("--tw-inset-shadow-color", "inherit")]
}
{
let n = e.get([`--inset-shadow-${t.value.value}`]);
if (n)
return [s(), S("--tw-inset-shadow-alpha", r), ...Ie("--tw-inset-shadow", n, r, (e => `var(--tw-inset-shadow-color, ${e})`)), S("box-shadow", i)]
}
{
let r = _e(t, e, ["--box-shadow-color", "--color"]);
if (r)
return [s(), S("--tw-inset-shadow-color", We(r, "var(--tw-inset-shadow-alpha)"))]
}
}
)),
r("inset-shadow", ( () => [{
...
if ("arbitrary" === t.value.kind) {
let r = t.value.value;
return "length" === (t.value.dataType ?? ce(r, ["color", "length"])) ? t.modifier ? void 0 : [s(), S("--tw-ring-shadow", o(r)), S("box-shadow", i)] : (r = De(r, t.modifier, e),
null === r ? void 0 : [S("--tw-ring-color", r)])
}
{
let r = _e(t, e, ["--ring-color", "--color"]);
if (r)
return [S("--tw-ring-color", r)]
}
{
if (t.modifier)
return;
let r = e.resolve(t.value.value, ["--ring-width"]);
if (null === r && Ae(t.value.value) && (r = `${t.value.value}px`),
r)
return [s(), S("--tw-ring-shadow", o(r)), S("box-shadow", i)]
}
}
...
if (!t.value)
return t.modifier ? void 0 : [s(), S("--tw-inset-ring-shadow", a("1px")), S("box-shadow", i)];
if ("arbitrary" === t.value.kind) {
let r = t.value.value;
return "length" === (t.value.dataType ?? ce(r, ["color", "length"])) ? t.modifier ? void 0 : [s(), S("--tw-inset-ring-shadow", a(r)), S("box-shadow", i)] : (r = De(r, t.modifier, e),
null === r ? void 0 : [S("--tw-inset-ring-color", r)])
}
{
let r = _e(t, e, ["--ring-color", "--color"]);
if (r)
return [S("--tw-inset-ring-color", r)]
}
{
if (t.modifier)
return;
...
if (null === r && Ae(t.value.value) && (r = `${t.value.value}px`),
r)
return [s(), S("--tw-inset-ring-shadow", a(r)), S("box-shadow", i)]
}
}
)),
r("inset-ring", ( () => [{
...
if ("arbitrary" === t.value.kind) {
let r = t.value.value;
return "length" === (t.value.dataType ?? ce(r, ["color", "length"])) ? t.modifier ? void 0 : [S("--tw-ring-offset-width", r), S("--tw-ring-offset-shadow", u)] : (r = De(r, t.modifier, e),
null === r ? void 0 : [S("--tw-ring-offset-color", r)])
}
{
let r = e.resolve(t.value.value, ["--ring-offset-width"]);
if (r)
return t.modifier ? void 0 : [S("--tw-ring-offset-width", r), S("--tw-ring-offset-shadow", u)];
if (Ae(t.value.value))
return t.modifier ? void 0 : [S("--tw-ring-offset-width", `${t.value.value}px`), S("--tw-ring-offset-shadow", u)]
}
{
let r = _e(t, e, ["--ring-offset-color", "--color"]);
if (r)
return [S("--tw-ring-offset-color", r)]
}
}
}
))
...
null !== t)
return e.modifier ? [S("container-type", t), S("container-name", e.modifier.value)] : [S("container-type", t)]
}
)),
r("@container", ( () => [{
values: ["normal"],
...
function i(e) {
return e.includes("::") ? null : `&:not(${q(e, ",").map((e => e.replaceAll("&", "*"))).join(", ")})`
}
...
{
let e = function() {
return T([A("@property", "--tw-content", [S("syntax", '"*"'), S("initial-value", '""'), S("inherits", "false")])])
};
t.static("before", (t => {
t.nodes = [$("&::before", [e(), S("content", "var(--tw-content)"), ...t.nodes])]
}
), {
compounds: 0
}),
t.static("after", (t => {
t.nodes = [$("&::after", [e(), S("content", "var(--tw-content)"), ...t.nodes])]
}
), {
compounds: 0
})
...
if (!t.value || t.modifier)
return null;
"arbitrary" === t.value.kind ? e.nodes = [$(`&[aria-${Qe(t.value.value)}]`, e.nodes)] : e.nodes = [$(`&[aria-${t.value.value}="true"]`, e.nodes)]
}
)),
...
if (!t.value || t.modifier || "named" === t.value.kind && !Ae(t.value.value))
return null;
...
if (null === r)
return null;
e.nodes = [A("@container", t.modifier ? `${t.modifier.value} (width < ${r})` : `(width < ${r})`, e.nodes)]
}
), {
compounds: 1
})
...
return null;
let t = D(e.slice(1, -1));
if (!I(t) || 0 === t.length || 0 === t.trim().length)
return null;
let r = ">" === t[0] || "+" === t[0] || "~" === t[0];
...
continue;
let n = D(r.slice(1, -1));
return I(n) && 0 !== n.length && 0 !== n.trim().length && "-" === n[0] && "-" === n[1] ? {
kind: "functional",
root: e,
modifier: t,
value: {
...
c = Z(i, (e => t.utilities.has(e, "functional")));
for (let[t,r] of c) {
let n = {
kind: "functional",
root: t,
...
if ("arbitrary" === e.kind) {
let r = e.value;
return e.modifier && (r = De(r, e.modifier, t.theme)),
...
, [o,a] = e ? ["(", ")"] : ["[", "]"];
t.value.dataType ? n += `-${o}${t.value.dataType}:${X(r)}${a}` : n += `-${o}${X(r)}${a}`
}
} else
"named" === t.value.kind && (n += `-${t.value.value}`);
return "arbitrary" === t.kind && (n += `[${t.property}:${X(t.value)}]`),
("arbitrary" === t.kind || "functional" === t.kind) && (n += Y(t.modifier)),
t.important && (n += "!"),
r.push(n),
r.join(":")
}(s, e),
...
let a = 0;
for (; a < r.properties.order.length && a < n.properties.order.length && r.properties.order[a] === n.properties.order[a]; )
a += 1;
return (r.properties.order[a] ?? 1 / 0) - (n.properties.order[a] ?? 1 / 0) || n.properties.count - r.properties.count || function(e, t) {
let r = e.length
, n = t.length
, o = r < n ? r : n;
for (let r = 0; r < o; r++) {
...
if ("arbitrary" === t.kind)
return t.relative && 0 === n ? null : void (e.nodes = [z(t.selector, e.nodes)]);
let {applyFn: o} = r.get(t.root);
if ("compound" === t.kind) {
let a = A("@slot");
if (null === at(a, t.variant, r, n + 1) || "not" === t.root && a.nodes.length > 1)
return null;
...
function lt(e) {
for (let t of e)
"at-root" !== t.kind && ("declaration" === t.kind ? t.important = !0 : ("rule" === t.kind || "at-rule" === t.kind) && lt(t.nodes))
}
function st(e) {
let t = new Set
, r = 0
...
throw "at-rule" === e.kind && "@utility" === e.name && "at-rule" === n.kind && "@utility" === n.name && k(e.nodes, (e => {
if ("at-rule" !== e.kind || "@apply" !== e.name)
return;
...
if ("function" === i.kind && "url" === i.value.toLowerCase() || !t)
return null;
...
e.theme.add("--default-font-feature-settings", ft(t.fontFamily.sans, "fontFeatureSettings") ?? "normal", r),
e.theme.add("--default-font-variation-settings", ft(t.fontFamily.sans, "fontVariationSettings") ?? "normal", r))
}
{
let n = ft(t.fontFamily.mono);
n && e.theme.hasDefault("--font-mono") && (e.theme.add("--default-mono-font-family", n, r),
e.theme.add("--default-mono-font-feature-settings", ft(t.fontFamily.mono, "fontFeatureSettings") ?? "normal", r),
e.theme.add("--default-mono-font-variation-settings", ft(t.fontFamily.mono, "fontVariationSettings") ?? "normal", r))
}
}
return t
}
...
n.push(t);
let a = r(e[t], o[t], n);
void 0 !== a ? e[t] = a : zt(e[t]) && zt(o[t]) ? e[t] = St({}, [e[t], o[t]], r, n) : e[t] = o[t],
n.pop()
}
return e
}
...
for (let t in a)
"__CSS_VALUES__" !== t && (4 & s?.__CSS_VALUES__?.[t] && void 0 !== jt(e, t.split("-")) || (e[i(t)] = a[t]));
return e
}
...
return l && "string" == typeof s && (s = We(s, l)),
s ?? o
}
}
function jt(e, t) {
...
function Kt({designSystem: e, ast: t, resolvedConfig: r, featuresRef: n, referenceMode: o, src: a}) {
let i = {
addBase(r) {
if (o)
return;
...
, i = !1;
if (k(n, (e => {
if ("selector" === e.kind && "." === e.value[0] && Vt.test(e.value.slice(1))) {
let t = e.value;
e.value = "&";
let o = xt(n)
, a = t.slice(1)
, s = "&" === o ? Et(r) : [z(o, Et(r))];
return l.get(a).push(...s),
i = !0,
void (e.value = t)
}
...
return l => {
if ("arbitrary" === l.value?.kind && o.length > 0 && !o.includes("any") && (l.value.dataType && !o.includes(l.value.dataType) || !l.value.dataType && !ce(l.value.value, o)))
return;
...
if (!Vt.test(a))
throw new Error(`\`matchUtilities({ '${a}' : … })\` defines an invalid utility name. Utilities should be alphanumeric and start with a lowercase letter, eg. \`scrollbar\`.`);
...
return i.addComponents = i.addComponents.bind(i),
...
let n = $t(e.selector);
k(n, (e => {
"selector" === e.kind && e.value === `.${t}` && (e.value = `.${a(r)}`)
}
)),
e.selector = xt(n)
}
...
function Yt(e, t) {
return Array.isArray(e) && zt(e[0]) ? e.concat(t) : Array.isArray(t) && zt(t[0]) && zt(e) ? [e, ...t] : Array.isArray(t) ? t : void 0
}
function Gt(e, {config: t, base: r, path: n, reference: o, src: a}) {
let i = [];
for (let e of t.plugins ?? [])
"__isOptionsFunction"in e ? i.push({
...e(),
reference: o,
src: a
}) : "handler"in e ? i.push({
...
let o = []
, a = null;
if (e && o.push(S("margin-inline", "auto")),
("string" == typeof t || "object" == typeof t && null !== t && "DEFAULT"in t) && o.push(S("padding-inline", "string" == typeof t ? t : t.DEFAULT)),
"object" == typeof r && null !== r) {
a = new Map;
let e = Array.from(n.theme.namespace("--breakpoint").entries());
if (e.sort(( (e, t) => ae(e[1], t[1], "asc"))),
e.length > 0) {
let[t] = e[0];
o.push(A("@media", `(width >= --theme(--breakpoint-${t}))`, [S("max-width", "none")]))
}
...
for (let[t,,r] of e)
if (a && a.has(t))
a.get(t).nodes.push(S("padding-inline", r));
else {
if (a)
continue;
o.push(A("@media", `(width >= theme(--breakpoint-${t}))`, [S("padding-inline", r)]))
}
}
if (a)
for (let[,e] of a)
...
var er = /^[a-z]+$/;
async function tr({designSystem: e, base: t, ast: r, loadModule: n, sources: o}) {
let a = 0
, i = []
, l = [];
k(r, ( (e, t) => {
...
return e.slice(1, -1);
if ("{" === e[0] && "}" === e[e.length - 1])
throw new Error(`Unexpected \`@plugin\` option: Value of declaration \`${N([t]).trim()}\` is not supported.\n\nUsing an object as a plugin option is currently only supported in JavaScript configuration files.`);
return e
}
));
...
e.utilities.static(`bg-gradient-to-${t}`, ( () => [S("--tw-gradient-position", `to ${r} in oklab`), S("background-image", "linear-gradient(var(--tw-gradient-stops))")]));
e.utilities.suggest("bg-left-top", ( () => [])),
e.utilities.static("bg-left-top", ( () => [S("background-position", "left top")])),
e.utilities.suggest("bg-right-top", ( () => [])),
e.utilities.static("bg-right-top", ( () => [S("background-position", "right top")])),
e.utilities.suggest("bg-left-bottom", ( () => [])),
e.utilities.static("bg-left-bottom", ( () => [S("background-position", "left bottom")])),
e.utilities.suggest("bg-right-bottom", ( () => [])),
e.utilities.static("bg-right-bottom", ( () => [S("background-position", "right bottom")])),
e.utilities.suggest("object-left-top", ( () => [])),
e.utilities.static("object-left-top", ( () => [S("object-position", "left top")])),
e.utilities.suggest("object-right-top", ( () => [])),
e.utilities.static("object-right-top", ( () => [S("object-position", "right top")])),
e.utilities.suggest("object-left-bottom", ( () => [])),
e.utilities.static("object-left-bottom", ( () => [S("object-position", "left bottom")])),
e.utilities.suggest("object-right-bottom", ( () => [])),
e.utilities.static("object-right-bottom", ( () => [S("object-position", "right bottom")])),
...
e.utilities.static("overflow-ellipsis", ( () => [S("text-overflow", "ellipsis")])),
e.utilities.suggest("decoration-slice", ( () => [])),
e.utilities.static("decoration-slice", ( () => [S("-webkit-box-decoration-break", "slice"), S("box-decoration-break", "slice")])),
e.utilities.suggest("decoration-clone", ( () => [])),
e.utilities.static("decoration-clone", ( () => [S("-webkit-box-decoration-break", "clone"), S("box-decoration-break", "clone")])),
e.utilities.suggest("flex-shrink", ( () => [])),
e.utilities.functional("flex-shrink", (e => {
if (!e.modifier) {
if (!e.value)
return [S("flex-shrink", "1")];
if ("arbitrary" === e.value.kind)
...
e.utilities.static("break-words", ( () => [S("overflow-wrap", "break-word")]))
}(e);
let s = e.resolveThemeValue;
if (e.resolveThemeValue = function(n, i) {
return n.startsWith("--") ? s(n, i) : (a |= rr({
designSystem: e,
base: t,
ast: r,
sources: o,
...
))), Promise.all(i.map((async ([{id: e, base: t, reference: r, src: o},a]) => {
...
function rr({designSystem: e, base: t, ast: r, sources: n, configs: o, pluginDetails: a}) {
let i = 0
, l = [...a.map((e => {
if (!e.options)
return {
...
return Array.isArray(r) && 2 === r.length ? r[0] : Array.isArray(r) ? r.join(", ") : "object" == typeof r && null !== r && "DEFAULT"in r ? r.DEFAULT : "string" == typeof r ? r : void 0
}
;
...
if (i && l && !t.theme.hasDefault(`--breakpoint-${e}`))
continue;
let s = !0;
"string" == typeof a && (s = !1);
let c = Qt(a);
...
return;
let n = K(r);
return "rule" === n.parent?.kind && n.parent.selector === e ? w.Stop : w.ReplaceStop($(e, [t]))
}
))
}
...
let l, s = o.slice(1, i), c = o.slice(i + 1);
l = function(e) {
return or.test(e)
}(s) ? function(e) {
let t = e.match(or);
...
async function cr(e, {base: t="", from: r, loadModule: n=lr, loadStylesheet: o=sr}={}) {
let l = 0;
e = [j({
base: t
}, e)],
l |= await dt(e, t, o, 0, void 0 !== r);
let s = null
, u = new c
, d = new Map
, f = new Map
...
} else if ("word" === t.kind && ("[" !== t.value[0] || "]" !== t.value[t.value.length - 1]) && !Me.includes(t.value)) {
...
let e = []
, t = [];
for (let[o,{literals: a, usedSpacingNumber: i, usedSpacingInteger: l, themeKeys: s}] of [[e, n["--value"]], [t, n["--modifier"]]]) {
for (let e of a)
o.push(e);
if (i)
o.push(...Oe);
...
, n = !1
, o = e.params;
if ("n" === o[0] && o.startsWith("not ") && (t = !0,
o = o.slice(4)),
"i" === o[0] && o.startsWith("inline(") && (n = !0,
o = o.slice(7, -1)),
'"' === o[0] && '"' !== o[o.length - 1] || "'" === o[0] && "'" !== o[o.length - 1] || "'" !== o[0] && '"' !== o[0])
throw new Error("`@source` paths must be quoted.");
let a = o.slice(1, -1);
if (n) {
let e = t ? C : x
...
if ("@variant" === e.name && (null === r.parent ? 0 === e.nodes.length ? e.name = "@custom-variant" : (k(e.nodes, (t => {
if ("at-rule" === t.kind && "@slot" === t.name)
return e.name = "@custom-variant",
w.Stop
}
)),
"@variant" === e.name && b.push(e)) : b.push(e)),
"@custom-variant" === e.name) {
if (null !== r.parent)
throw new Error("`@custom-variant` cannot be nested.");
let[t,n] = q(e.params, " ");
if (!Ge.test(t))
throw new Error(`\`@custom-variant ${t}\` defines an invalid variant name. Variants should only contain alphanumeric, dashes, or underscore characters and start with a lowercase letter or number.`);
if (e.nodes.length > 0 && n)
throw new Error(`\`@custom-variant ${t}\` cannot have both a selector and a body.`);
if (0 === e.nodes.length) {
if (!n)
throw new Error(`\`@custom-variant ${t}\` has no selector or body.`);
let e = q(n.slice(1, -1), ",");
...
"important" === o ? s = !0 : "reference" === o ? e.nodes = [j({
reference: !0
}, e.nodes)] : n.push(o);
if (n.length > 0)
e.params = n.join(" ");
else if (t.length > 0)
return w.Replace(e.nodes);
return w.Continue
}
if ("@theme" === e.name) {
let[t,n] = function(e) {
...
let n = N([A(e.name, e.params, [r])]).split("\n").map(( (e, t, r) => `${0 === t || t >= r.length - 2 ? " " : ">"} ${e}`)).join("\n");
throw new Error(`\`@theme\` blocks must only contain custom properties or \`@keyframes\`.\n\n${n}`)
}
)),
g ? w.ReplaceSkip([]) : (g = $(":root, :host", []),
g.src = e.src,
w.ReplaceSkip(g))
}
}
...
function a(i, l=[]) {
if (e.has(i) && !r.has(i)) {
n.has(i) && t.onCircularDependency?.(l, i),
n.add(i);
...
let r = N(e.map(( (r, n) => A("@custom-variant", r, [A("@variant", e[n + 1] ?? t, [])])))).replaceAll(";", " { … }").replace(`@custom-variant ${t} {`, `@custom-variant ${t} { /* ← */`);
...
let {designSystem: r, ast: n, sources: o, root: a, utilitiesNode: i, features: l, inlineCandidates: s} = await cr(e, t);
function c(e) {
r.invalidCandidates.add(e)
}
n.unshift(C("! tailwindcss v4.1.16 | MIT License | https://tailwindcss.com "));
let u = new Set
, d = null
, f = 0
, p = !1;
...
}, pr = "text/tailwindcss", hr = new Set, mr = "", gr = document.createElement("style"), vr = Promise.resolve(), wr = 1, kr = new class {
start(e) {
...
return kr.hit("Loaded stylesheet", {
id: e,
base: t,
...
throw kr.hit("Failed to load stylesheet", {
id: e,
base: t,
error: r.message ?? r
}),
...
kr.start("Create compiler"),
kr.start("Reading Stylesheets");
...
hr.has(r) || (hr.add(r),
t.add(r));
kr.end("Collect classes", {
count: t.size
}),
(0 !== t.size || "incremental" !== e) && (kr.start("Build utilities"),
...
e.nodeType === Node.ELEMENT_NODE && "STYLE" === e.tagName && e.getAttribute("type") === pr && (Ar(e),
t++);
for (let e of n.addedNodes)
1 === e.nodeType && e !== gr && r++;
"attributes" === n.type && r++
