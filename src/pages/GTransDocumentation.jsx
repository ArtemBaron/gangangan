...
export default function GTransDocumentation() {
  ...
  const sections = [
    ...
    {
      icon: CreditCard,
      title: language === 'en' ? 'Service Scope' : 'Cakupan Layanan',
      description: language === 'en'
        ? 'Comprehensive cross-border payment solutions for various business needs.'
        : 'Solusi pembayaran lintas batas yang komprehensif untuk berbagai kebutuhan bisnis.',
      items: [
        language === 'en' ? 'Outbound transfers from Indonesia' : 'Transfer keluar dari Indonesia',
        language === 'en' ? 'Inbound collections to Indonesia' : 'Koleksi masuk ke Indonesia',
        language === 'en' ? 'With or without FX conversion' : 'Dengan atau tanpa konversi FX',
        language === 'en' ? 'Multi-currency payouts and collections' : 'Pembayaran dan koleksi multi-mata uang'
      ]
    }
  ];
