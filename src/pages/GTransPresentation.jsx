...
export default function GTransPresentation() {
  ...
  const slides = [
    ...
    // Slide 4 - Product Portfolio
    {
      ...
      content: (
        <div className="min-h-screen bg-slate-50 p-8 md:p-16">
          ...
          <p className="text-slate-600 mb-12">Operating under Bank Indonesia's PSP licensing framework for remittance</p>
    ...
    // Slide 5 - Legal Basis & Service Scope
    {
      id: 'legal',
      content: (
        <div className="min-h-screen bg-white p-8 md:p-16">
          <h2 className="text-4xl font-bold text-[#1e3a5f] mb-12">GTrans: Legal Basis & Service Scope</h2>
          ...
          <div className="grid md:grid-cols-2 gap-12 max-w-6xl mx-auto">
            <div className="space-y-8">
              <div>
                <h3 className="text-xl font-bold text-[#1e3a5f] mb-4 flex items-center gap-2">
                  ...
                  Legal Basis (BI PSP Remittance)
                </h3>
                <p className="text-slate-600">
                  Licensed Remittance Payment Service Provider under Bank Indonesia regulations, meeting all compliance requirements for cross-border fund transfers.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-slate-600">
                  GAN operates as Executing Sender, limited to transfer and settlement of funds per client instructions. No liability for underlying commercial transactions between parties.
                </p>
              </div>
            </div>
            ...
            <div>
              <h3 className="text-xl font-bold text-[#1e3a5f] mb-4 flex items-center gap-2">
                ...
                GTrans Service Scope
              </h3>
              <div className="space-y-4">
                <div className="bg-slate-50 rounded-lg p-4">
                  <h4 className="font-semibold text-slate-800 mb-2">Without FX Conversion</h4>
                  <p className="text-sm text-slate-600">Original currency → Same currency beneficiaries</p>
                </div>
                <div className="bg-[#f5a623]/10 rounded-lg p-4">
                  <h4 className="font-semibold text-slate-800 mb-2">With FX Conversion</h4>
                  <p className="text-sm text-slate-600">Convert between supported currencies at client's instruction</p>
                </div>
                <div className="mt-6">
                  <h4 className="font-medium text-slate-700 mb-3">Supported Currencies:</h4>
                  <div className="flex flex-wrap gap-2">
                    {['AUD', 'CAD', 'CHF', 'DKK', 'EUR', 'GBP', 'JPY', 'MYR', 'NOK', 'NZD', 'SAR', 'THB', 'SEK', 'SGD', 'USD', 'HKD', 'CNY', 'IDR'].map(cur => (
                      <span key={cur} className="px-3 py-1 bg-slate-100 rounded text-sm font-medium text-slate-700">
                        {cur}
                      </span>
                    ))}
                  </div>
    ...
    // Slide 6 - eCommerce Flow
    {
      id: 'ecommerce',
      content: (
        <div className="min-h-screen bg-slate-50 p-8 md:p-16">
          <h2 className="text-4xl font-bold text-[#1e3a5f] mb-4">GTrans – eCommerce Collect & Settle</h2>
          <p className="text-slate-600 mb-12">Non-IDR collection with local currency settlement</p>
          
          <div className="max-w-5xl mx-auto">
            <div className="grid md:grid-cols-2 gap-8 mb-12">
              <Card className="border-slate-200">
                <CardContent className="p-6">
                  <h3 className="text-lg font-bold text-[#1e3a5f] mb-4">Collection Service</h3>
                  <p className="text-slate-600">Non-IDR buyer payments into GAN accounts with partner banks. Funds held securely until settlement.</p>
                </CardContent>
              </Card>
              <Card className="border-slate-200">
                <CardContent className="p-6">
                  <h3 className="text-lg font-bold text-[#1e3a5f] mb-4">Payout Service</h3>
                  <p className="text-slate-600">Settlement to Indonesian sellers in IDR or agreed currency. Fast, reliable disbursement.</p>
                </CardContent>
              </Card>
            </div>
            ...
            <Card className="border-slate-200">
              <CardContent className="p-8">
                <h3 className="text-xl font-bold text-[#1e3a5f] mb-6">Example: Collection Flow</h3>
                <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
                  {[
                    'Customer selects goods',
                    'Merchant creates order',
                    'Provider X processes',
                    'Bank X holds funds',
                    'Payment confirmed',
                    'Matching & FX',
                    'Settlement'
                    ...
                    <div key={idx} className="flex items-center gap-2">
                      ...
                      {idx < 6 && <ArrowRight className="w-4 h-4 text-slate-300 hidden md:block" />}
                    </div>
                  ))}
                </div>
              </CardContent>
